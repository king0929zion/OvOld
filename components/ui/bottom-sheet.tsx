...
export function BottomSheet({ isOpen, onClose, children, title }: BottomSheetProps) {
  ...
  return (
    <div className={cn("fixed inset-0 z-[100] flex flex-col justify-end transition-opacity duration-300", isOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none")}>
      ...
      <div className={cn("relative w-full bg-surface rounded-t-[28px] p-6 pb-12 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] transition-transform duration-300", isOpen ? "translate-y-0" : "translate-y-full")}>
